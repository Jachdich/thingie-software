...
#define ADCDAC_VOL_BUSY_DAC_RIGHT (1 << 13)
...
#define ADCDAC_VOL_BUSY_DAC_LEFT (1 << 12)
// 12	VOL_BUSY_DAC_LEFT  Volume Busy DAC Left
//				0x0 = Ready
//				0x1 = Busy - This indicates the channel has not reached its
//					programmed volume/mute level
#define ADCDAC_VOL_RAMP_ENABLE (1 << 9)
...
#define ADCDAC_ADC_HPF_BYPASS (1 << 0)
...
#define ANA_POWER_HEADPHONE_POWERUP         (1 << 4)
// 4	HEADPHONE_POWERUP Power up the headphone amplifiers
//				0x0 = Power down, 0x1 = Power up
#define ANA_POWER_DAC_POWERUP               (1 << 3)
